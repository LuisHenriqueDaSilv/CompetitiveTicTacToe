...
def user_validation_email(email_service:EmailService, user: UserModel, url: str):
  email = MIMEMultipart()
  ...
  content = MIMEText(f"""
    ...
    <div align="center">
      ...
      <a href="{url}?code={user.validation_code}&email={user.email}" target="_blank">clique aqui para acessar a página de validação</a>
    </div></br>
    </br>
